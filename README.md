...
EXPO_PUBLIC_APPWRITE_PROJECT_ID= ADD YOUR PROJECT ID
EXPO_PUBLIC_APPWRITE_DATABASE_ID= ADD YOUR DATABASE ID
EXPO_PUBLIC_APPWRITE_GALLERIES_COLLECTION_ID= ADD YOUR GALLERIES COLLECTION ID
EXPO_PUBLIC_APPWRITE_REVIEWS_COLLECTION_ID= ADD YOUR REVIEWS COLLECTION ID
EXPO_PUBLIC_APPWRITE_AGENTS_COLLECTION_ID= ADD YOUR AGENTS COLLECTION ID
EXPO_PUBLIC_APPWRITE_PROPERTIES_COLLECTION_ID= ADD YOUR PROPERTIES ID
```
